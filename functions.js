...
/*
pathStr = "M442.32327924778474,258.3986189080606L442.508379662464,258.4866036194726L442.7551802153703,258.61858057702193L442.94028063004953,258.7945496492175L442.94028063004953,258.88253409763274L443.00198076827473,259.1024949631392L443.00198076827473,259.2344713071652L442.94028063004953,259.3224554634362L442.7551802153703,259.5424155984656L442.570079800691,259.63039955034037L442.32327924778474,259.71838344360003L442.32327924778474,258.92652629999793Z";
myPath = parse_path(pathStr);
topLeft = find_topleft(myPath);
console.log(generate_translatecode(topLeft, [10,5]));
*/

d3.json(jsonPath, function(error, us) {
  retjson = us;
  console.log(us);
  leisure = us.objects.geojson;
  var geometries = topojson.feature(us, leisure);
    g.selectAll("path")
    ...
    .attr("d", function(d) {
      ...
      //console.log("translated", d, "to", transpath);
      return transpath;
    })
    .style("stroke", "black");
});
...
arrangeItems = function(event) {
  ...
  var items = g.selectAll('path.parks');
